  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        ...
        <p>We provide the AI Products through third-party service providers ("AI Service Providers"), including v0 and OpenAI. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
        ...
        <ul>
          <li>Category A - As long as the user has an account with us, or the platform is caneled.</li>
          <li>Category B - As long as the user has an account with us, or the platform is canceled.</li>
        </ul>
        ...
        <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at eduardoescobar0621@gmail.com, or by referring to the contact details at the bottom of this document.</p>
        ...
        <h2>14. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        ...
        <p><a href="https://inforegulator.org.za/" target="_blank" rel="noopener noreferrer">The Information Regulator (South Africa)</a></p>
        ...
        <p>If you have questions or comments about this notice, you may email us at eduardoescobar0621@gmail.com or contact us by post at:</p>

        <p>__________</p>
        <p>1830 New York Ave</p>
        ...
        <p>We will respond to your request within 30 days. If we require more time (up to 60 days), we will inform you of the reason and extension period in writing. If you are a resident of California, you have specific rights regarding the access and deletion of your personal data. To exercise these rights, please see our California Privacy Rights section above.</p>
        <p>If you have any questions or concerns about our privacy practices or this Privacy Notice, please contact us using the information provided in the "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" section above.</p>
      </div>
      <div className="mt-8">
